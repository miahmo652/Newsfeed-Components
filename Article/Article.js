...
function comp(titledata, datedata, firstp, secondp, thirdp) {
    ...
    first.textContent = firstp;

    const second = document.createElement('p');
    second.textContent = secondp;

    const third = document.createElement('p');
    third.textContent = thirdp;
...
data.forEach((dat) => {
    const com = comp(dat.title, dat.date, dat.firstParagraph, dat.secondParagraph, dat.thirdParagraph);
    console.log(com)
    art.appendChild(com);
